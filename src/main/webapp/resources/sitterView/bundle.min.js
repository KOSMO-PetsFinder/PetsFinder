...
var Sentry = (function (n) {
  ...
  function o() {
    for (var n = [], t = 0; t < arguments.length; t++) n = n.concat(i(arguments[t]));
    return n;
  }
  var u, c, s;
  !(function (n) {
  ...
  var f = (function (n) {
    function t(t) {
      ...
      return (e.message = t), (e.name = r.prototype.constructor.name), a(e, r.prototype), e;
    }
    return r(t, n), t;
  })(Error);
  function h(n) {
  ...
  function _(n, t, r, e) {
    void 0 === e && (e = { handled: !0, type: 'generic' }),
  ...
  var T = S.__SENTRY__.logger || (S.__SENTRY__.logger = new k()),
    R = (function () {
      function n() {
  ...
  function C(n, t) {
    return 'domain' === t && 'object' == typeof n && n.u
      ...
      ? '[Document]'
      : 'undefined' != typeof Event && n instanceof Event
      ? Object.getPrototypeOf(n)
        ? n.constructor.name
        : 'Event'
      : m((r = n)) && 'nativeEvent' in r && 'preventDefault' in r && 'stopPropagation' in r
      ? '[SyntheticEvent]'
      : Number.isNaN(n)
      ? '[NaN]'
      : void 0 === n
  ...
  function A(n, t, r, e) {
    if ((void 0 === r && (r = 1 / 0), void 0 === e && (e = new R()), 0 === r))
      return (function (n) {
    ...
    for (var c in o) Object.prototype.hasOwnProperty.call(o, c) && (u[c] = A(c, o[c], r - 1, e));
    ...
    M = (function () {
      ...
      return (
        ...
        (n.prototype.add = function (n) {
          var t = this;
          return this.isReady()
            ? (-1 === this.h.indexOf(n) && this.h.push(n),
              n
                .then(function () {
                  return t.remove(n);
                })
              ...
              n)
            : Promise.reject(new f('Not adding Promise due to buffer limit reached.'));
        }),
  ...
  var B = (function () {
      function n(n) {
        ...
        (this.l = L.PENDING),
          ...
          (this.m = function (n, r) {
            t.l === L.PENDING && (y(n) ? n.then(t.p, t.g) : ((t.j = n), (t.l = r), t._()));
          }),
          (this._ = function () {
            t.l !== L.PENDING &&
              (t.l === L.REJECTED
    ...
    J = /^[ \t]*([0-9a-f]{32})?-?([0-9a-f]{16})?-?([01])?[ \t]*$/,
    X = (function () {
      function n(n, t, r, e) {
        void 0 === n && (n = g()), void 0 === t && (t = g().substring(16)), (this.O = n), (this.k = t), (this.T = r), (this.R = e);
      }
      return (
        ...
        (n.prototype.toTraceparent = function () {
          var n = '';
          return !0 === this.T ? (n = '-1') : !1 === this.T && (n = '-0'), this.O + '-' + this.k + n;
        }),
        (n.prototype.toJSON = function () {
          return { parent: (this.R && this.R.toJSON()) || void 0, sampled: this.T, span_id: this.k, trace_id: this.O };
        }),
        n
      );
    })(),
    z = (function () {
      function n() {
        (this.D = !1), (this.I = []), (this.N = []), (this.C = []), (this.A = {}), (this.U = {}), (this.L = {}), (this.M = {});
      }
      return (
        ...
        (n.prototype.P = function (n, t, r, i) {
          var o = this;
          return (
            void 0 === i && (i = 0),
            new B(function (u, c) {
        ...
        (n.prototype.setUser = function (n) {
          return (this.A = U(n)), this.F(), this;
        }),
        (n.prototype.setTags = function (n) {
          return (this.U = e({}, this.U, U(n))), this.F(), this;
        }),
        (n.prototype.setTag = function (n, t) {
          var r;
          return (this.U = e({}, this.U, (((r = {})[n] = U(t)), r))), this.F(), this;
        }),
        (n.prototype.setExtras = function (n) {
          return (this.L = e({}, this.L, U(n))), this.F(), this;
        }),
        (n.prototype.setExtra = function (n, t) {
          var r;
          return (this.L = e({}, this.L, (((r = {})[n] = U(t)), r))), this.F(), this;
        }),
        (n.prototype.setFingerprint = function (n) {
          return (this.$ = U(n)), this.F(), this;
        }),
        (n.prototype.setLevel = function (n) {
          return (this.q = U(n)), this.F(), this;
        }),
        (n.prototype.setTransaction = function (n) {
          return (this.H = n), this.F(), this;
        }),
        (n.prototype.setContext = function (n, t) {
          return (this.M[n] = t ? U(t) : void 0), this.F(), this;
        }),
        ...
        (n.prototype.addBreadcrumb = function (n, t) {
          var r = new Date().getTime() / 1e3,
            i = e({ timestamp: r }, n);
          return (this.C = void 0 !== t && t >= 0 ? o(this.C, [U(i)]).slice(-t) : o(this.C, [U(i)])), this.F(), this;
        }),
        ...
        (n.prototype.applyToEvent = function (n, t) {
          return (
            this.L && Object.keys(this.L).length && (n.extra = e({}, this.L, n.extra)),
            this.U && Object.keys(this.U).length && (n.tags = e({}, this.U, n.tags)),
            this.A && Object.keys(this.A).length && (n.user = e({}, this.A, n.user)),
            this.M && Object.keys(this.M).length && (n.contexts = e({}, this.M, n.contexts)),
            this.q && (n.level = this.q),
            this.H && (n.transaction = this.H),
            this.W && ((n.contexts = n.contexts || {}), (n.contexts.trace = this.W)),
            this.B(n),
            (n.breadcrumbs = o(n.breadcrumbs || [], this.C)),
            (n.breadcrumbs = n.breadcrumbs.length > 0 ? n.breadcrumbs : void 0),
            this.P(o(G(), this.N), n, t)
          );
        }),
        n
      );
  ...
  var K = 3,
    Z = (function () {
      function n(n, t, r) {
        void 0 === t && (t = new z()), void 0 === r && (r = K), (this.J = r), (this.X = []), this.X.push({ client: n, scope: t });
      }
      return (
        (n.prototype.G = function (n) {
          for (var t, r = [], e = 1; e < arguments.length; e++) r[e - 1] = arguments[e];
          var i = this.getStackTop();
          i && i.client && i.client[n] && (t = i.client)[n].apply(t, o(r, [i.scope]));
        }),
        ...
        (n.prototype.captureException = function (n, t) {
          ...
          return this.G('captureException', n, e({}, i, { event_id: r })), r;
        }),
        (n.prototype.captureMessage = function (n, t, r) {
          ...
          return this.G('captureMessage', n, t, e({}, o, { event_id: i })), i;
        }),
        (n.prototype.captureEvent = function (n, t) {
          var r = (this.V = g());
          return this.G('captureEvent', n, e({}, t, { event_id: r })), r;
        }),
  ...
  function rn(n) {
    return n && n.__SENTRY__ && n.__SENTRY__.hub
      ? n.__SENTRY__.hub
      : ((n.__SENTRY__ = n.__SENTRY__ || {}), (n.__SENTRY__.hub = new Z()), n.__SENTRY__.hub);
  }
  function en(n, t) {
  ...
  function captureException(n) {
    ...
    return on('captureException', n, { originalException: n, syntheticException: t });
  }
  function un(n) {
    on('withScope', n);
  }
      ...
      return (
        ...
        (n.prototype.K = function (n) {
          ...
          var r = i(t.slice(1), 6),
            ...
            v = r[5],
            d = v.split('/');
          d.length > 1 && ((l = d.slice(0, -1).join('/')), (v = d.pop())),
            Object.assign(this, { host: s, pass: c, path: l, projectId: v, port: h, protocol: e, user: o });
        }),
      ...
      return (
        ...
        (n.prototype.getRequestHeaders = function (n, t) {
          ...
          return (
            ...
            { 'Content-Type': 'application/json', 'X-Sentry-Auth': e.join(', ') }
          );
        }),
      ...
      (function (n) {
        ...
        if (Array.isArray(r)) {
          ...
          t.forEach(function (n) {
            -1 === i.indexOf(n.name) && -1 === u.indexOf(n.name) && (e.push(n), u.push(n.name));
          }),
  ...
  var ln,
    vn = (function () {
      function n(n, t) {
        (this.rn = {}),
          ...
          (this.in = new n(t)),
          (this.on = t),
          t.dsn && (this.un = new sn(t.dsn)),
          this.cn() && (this.rn = hn(this.on));
      }
      return (
        ...
        (n.prototype.captureMessage = function (n, t, r, e) {
          ...
          return (
            (this.en = !0),
            (p(n) ? this.sn().eventFromMessage('' + n, t, r) : this.sn().eventFromException(n, r))
              .then(function (n) {
                return i.an(n, r, e);
              })
              .then(function (n) {
          ...
          return new Promise(function (r) {
            ...
            clearInterval(i),
              (i = setInterval(function () {
                t.en ? ((e += 1), n && e >= n && r({ interval: i, ready: !1 })) : r({ interval: i, ready: !0 });
              }, 1));
          });
        }),
        ...
        (n.prototype.hn = function (n, t, r) {
          ...
          void 0 === f.environment && void 0 !== o && (f.environment = o),
            ...
            f.message && (f.message = F(f.message, a));
          var h = f.exception && f.exception.values && f.exception.values[0];
          h && h.value && (h.value = F(h.value, a));
          var l = f.request;
          l && l.url && (l.url = F(l.url, a)), void 0 === f.event_id && (f.event_id = g()), this.ln(f.sdk);
          var v = B.resolve(f);
        ...
        (n.prototype.an = function (n, t, r) {
          ...
          return this.cn()
            ? 'number' == typeof u && Math.random() > u
              ? B.reject('This event has been sampled, will not send event.')
              : new B(function (i, u) {
                  e.hn(n, r, t).then(function (n) {
                    if (null !== n) {
                      ...
                      try {
                        ...
                        var c = o(n, t);
                        if (void 0 === c) T.error('`beforeSend` method has to return `null` or a valid event.');
                        else if (y(c)) e.vn(c, i, u);
                        else {
                          if (null === (r = c)) return T.log('`beforeSend` returned `null`, will not send event.'), void i(null);
                          e.sn().sendEvent(r), i(r);
                        }
                      } catch (n) {
                        e.captureException(n, { data: { __sentry__: !0 }, originalException: n }),
    ...
    pn = (function () {
      function n(n) {
        (this.on = n), this.on.dsn || T.warn('No DSN provided, backend will not do anything.'), (this.dn = this.pn());
      }
      return (
  ...
  var mn = (function () {
    ...
    bn = (function () {
      ...
      return (
        ...
        (n.prototype.yn = function (n, t) {
          return this.bn(n, t)
            ? (T.warn('Event dropped due to being internal Sentry Error.\nEvent: ' + j(n)), !0)
            : this.wn(n, t)
            ? (T.warn('Event dropped due to being matched by `ignoreErrors` option.\nEvent: ' + j(n)), !0)
            : this.gn(n, t)
            ? (T.warn('Event dropped due to being matched by `blacklistUrls` option.\nEvent: ' + j(n) + '.\nUrl: ' + this.En(n)), !0)
            : !this.jn(n, t) &&
              (T.warn('Event dropped due to not being matched by `whitelistUrls` option.\nEvent: ' + j(n) + '.\nUrl: ' + this.En(n)), !0);
        }),
        ...
        (n.prototype.mn = function (n) {
          return (
            void 0 === n && (n = {}),
            {
              blacklistUrls: o(this.on.blacklistUrls || [], n.blacklistUrls || []),
              ignoreErrors: o(this.on.ignoreErrors || [], n.ignoreErrors || [], yn),
              ignoreInternal: void 0 === this.on.ignoreInternal || this.on.ignoreInternal,
              whitelistUrls: o(this.on.whitelistUrls || [], n.whitelistUrls || []),
            }
          );
        }),
        (n.prototype.xn = function (n) {
          if (n.message) return [n.message];
          if (n.exception)
            try {
              var t = n.exception.values[0],
    ...
    wn = Object.freeze({ FunctionToString: mn, InboundFilters: bn }),
    gn = w(),
    En = { _n: !1, Sn: !1, On: !1, kn: !1 },
    jn = '?',
    xn = /^(?:[Uu]ncaught (?:exception: )?)?(?:((?:Eval|Internal|Range|Reference|Syntax|Type|URI|)Error): )?(.*)$/;
  function _n(n, t) {
  ...
  (En._n = (function () {
    ...
    function c(t, r, i, c, s) {
      var f = null;
      if (((s = l(s) ? s.error : s), (t = l(t) ? t.message : t), o)) En.On.Tn(o, r, i, t), a();
      else if (s && h(s)) ((f = En.On(s)).mechanism = 'onerror'), u(f, !0, s);
      else {
        var v,
          d = { url: r, line: i, column: c },
          p = t;
        ...
        (d.func = jn),
          (d.context = null),
          u((f = { name: v, message: p, mode: 'onerror', mechanism: 'onerror', stack: [e({}, d, { url: d.url || Sn() })] }), !0, null);
      }
    ...
    function s(n) {
      var t = n;
      try {
        t = n && 'reason' in n ? n.reason : n;
      } catch (n) {}
      var r = En.On(t);
      (r.mechanism = 'onunhandledrejection'), u(r, !0, t);
    }
    function a() {
      var n = o,
        t = i;
      (o = null), (i = null), u(n, !1, t);
    }
    function f(n) {
      if (o) {
        if (i === n) return;
    ...
    return (
      ...
      (f.Dn = function () {
        !0 !== t && ((n = gn.onerror), (gn.onerror = c), (t = !0));
      }),
      (f.In = function () {
        gn.onunhandledrejection = s;
      }),
      f
    );
  })()),
    (En.On = (function () {
      function n(n) {
        ...
        for (
          ...
          if ((r = i.exec(a[l]))) {
            ...
            r[2] && 0 === r[2].indexOf('eval') && (t = s.exec(r[2])) && ((r[2] = t[1]), (r[3] = t[2]), (r[4] = t[3])),
              (e = { url: r[2], func: r[1] || jn, args: d ? [r[2]] : [], line: r[3] ? +r[3] : null, column: r[4] ? +r[4] : null });
          } else if ((r = u.exec(a[l]))) e = { url: r[2], func: r[1] || jn, args: [], line: +r[3], column: r[4] ? +r[4] : null };
          else {
            if (!(r = o.exec(a[l]))) continue;
            r[3] && r[3].indexOf(' > eval') > -1 && (t = c.exec(r[3]))
              ? ((r[1] = r[1] || 'eval'), (r[3] = t[1]), (r[4] = t[2]), (r[5] = ''))
              : 0 !== l || r[5] || void 0 === n.columnNumber || (f[0].column = n.columnNumber + 1),
              (e = {
                url: r[3],
                func: r[1] || jn,
                args: r[2] ? r[2].split(',') : [],
          ...
          !e.func && e.line && (e.func = jn), (e.context = null), f.push(e);
        }
        return f.length
          ? (f[0] && f[0].line && !f[0].column && h && (f[0].column = null), { mode: 'stack', name: n.name, message: n.message, stack: f })
          : null;
      }
      function t(n, t, r, e) {
        var i = { url: t, line: r };
        if (i.url && i.line) {
          if (
            ...
            / '([^']+)' /.exec(e) && (i.column = null),
            n.stack.length > 0 && n.stack[0].url === i.url)
          ) {
      ...
      function r(n, e) {
        for (
          var i, o, u = /function\s+([_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*)?\s*\(/i, c = [], s = {}, a = !1, f = r.caller;
          f && !a;
          f = f.caller
        )
          if (f !== Rn && f !== En._n) {
            if (
              ((o = { url: null, func: jn, args: [], line: null, column: null }),
              f.name ? (o.func = f.name) : (i = u.exec(f.toString())) && (o.func = i[1]),
              void 0 === o.func)
            )
              try {
            ...
            (i = (function (n) {
              ...
              if (t) {
                for (
                  ...
                  var s = null;
                  (r = e.exec(o[c]))
                    ? (s = { url: r[2], line: +r[1], column: null, func: r[3], args: [] })
                    : (r = i.exec(o[c])) &&
                      (s = { url: r[6], line: +r[1], column: +r[2], func: r[3] || r[4], args: r[5] ? r[5].split(',') : [] }),
                    s &&
                      (!s.func && s.line && (s.func = jn), s.line && (s.context = null), s.context || (s.context = [o[c + 1]]), u.push(s));
                }
        ...
        try {
          if (
            (i = (function (n) {
              ...
              var r,
                e = /^\s*Line (\d+) of linked script ((?:file|https?|blob)\S+)(?:: in function (\S+))?\s*$/i,
                i = /^\s*Line (\d+) of inline#(\d+) script in ((?:file|https?|blob)\S+)(?:: in function (\S+))?\s*$/i,
                o = /^\s*Line (\d+) of function script\s*$/i,
                u = [],
                c = gn && gn.document && gn.document.getElementsByTagName('script'),
                s = [];
              for (var a in c) _n(c, a) && !c[a].src && s.push(c[a]);
              for (var f = 2; f < t.length; f += 2) {
                var h = null;
                (r = e.exec(t[f]))
                  ? (h = { url: r[2], func: r[3], args: [], line: +r[1], column: null })
                  : (r = i.exec(t[f]))
                  ? (h = { url: r[3], func: r[4], args: [], line: +r[1], column: null })
                  : (r = o.exec(t[f])) && (h = { url: Sn().replace(/#.*$/, ''), func: '', args: [], line: r[1], column: null }),
                  h && (h.func || (h.func = jn), (h.context = [t[f + 1]]), u.push(h));
              }
  ...
  function In(n) {
    ...
    return (
      t && t.length && (r.stacktrace = { frames: t }), void 0 === r.type && '' === r.value && (r.value = 'Unrecoverable error caught'), r
    );
  }
  function Nn(n) {
    return { exception: { values: [In(n)] } };
  }
  function Cn(n) {
    ...
    var t = n,
      ...
      e = t[t.length - 1].func || '';
    return (
      (r.includes('captureMessage') || r.includes('captureException')) && (t = t.slice(1)),
      e.includes('sentryWrapped') && (t = t.slice(0, -1)),
      t
        .map(function (n) {
  ...
  var An,
    ...
    Ln = (function () {
      function n(n) {
        (this.options = n), (this.h = new M(30)), (this.url = new an(this.options.dsn).getStoreEndpointWithUrlEncodedAuth());
      }
      return (
        (n.prototype.sendEvent = function (n) {
    ...
    Fn = (function (t) {
      ...
      return (
        ...
        (e.prototype.sendEvent = function (t) {
          var r = { body: JSON.stringify(t), method: 'POST', referrerPolicy: W() ? 'origin' : '' };
          return this.h.add(
            Mn.fetch(this.url, r).then(function (t) {
          ...
          return this.h.add(
            new Promise(function (e, i) {
              ...
              (o.onreadystatechange = function () {
                4 === o.readyState && (200 === o.status && e({ status: n.Status.fromHttpCode(o.status) }), i(o));
              }),
                o.open('POST', r.url),
    ...
    $n = Object.freeze({ BaseTransport: Ln, FetchTransport: Fn, XHRTransport: Pn }),
    qn = (function (t) {
      function i() {
        return (null !== t && t.apply(this, arguments)) || this;
      }
      return (
        ...
        (i.prototype.eventFromException = function (t, r) {
          var e,
            i,
            o = this;
          if (l(t) && t.error) return (t = t.error), (e = Nn(Rn(t))), B.resolve(this.Cn(e, r));
          if (v(t) || ((i = t), '[object DOMException]' === Object.prototype.toString.call(i))) {
            var u = t,
              c = u.name || (v(u) ? 'DOMError' : 'DOMException'),
          ...
          if (h(t)) return (e = Nn(Rn(t))), B.resolve(this.Cn(e, r));
          if (m(t) && r && r.syntheticException)
            return (
              _(
                (e = (function (n, t) {
                  var r = Object.keys(n).sort(),
                    e = { extra: { __serialized__: N(n) }, message: 'Non-Error exception captured with keys: ' + $(r) };
                  if (t) {
                    var i = Cn(Rn(t).stack);
                    e.stacktrace = { frames: i };
                  }
                  return e;
                })(t, r.syntheticException)),
                'Custom Object',
                void 0,
                { handled: !0, synthetic: !0, type: 'generic' }
              ),
              (e.level = n.Severity.Error),
              B.resolve(this.Cn(e, r))
            );
          var a = t;
          return this.eventFromMessage(a, void 0, r).then(function (t) {
            return (
              _(t, '' + a, void 0, { handled: !0, synthetic: !0, type: 'generic' }), (t.level = n.Severity.Error), B.resolve(o.Cn(t, r))
            );
          });
        }),
        (i.prototype.Cn = function (n, t) {
          return e({}, n, { event_id: t && t.event_id });
        }),
        (i.prototype.eventFromMessage = function (t, r, e) {
          ...
          if (this.on.attachStacktrace && e && e.syntheticException) {
            var o = Cn(Rn(e.syntheticException).stack);
    ...
    Hn = 'sentry.javascript.browser',
    Wn = (function (n) {
      function t(t) {
        return void 0 === t && (t = {}), n.call(this, qn, t) || this;
      }
      return (
        r(t, n),
        (t.prototype.hn = function (t, r, i) {
          return (
            ...
            (t.sdk = e({}, t.sdk, {
              name: Hn,
              packages: o((t.sdk && t.sdk.packages) || [], [{ name: 'npm:@sentry/browser', version: '5.6.2' }]),
              version: '5.6.2',
            })),
            ...
            if (this.cn()) {
              ...
              if (n.eventId)
                if (r) {
                  ...
                  (e.async = !0),
                    (e.src = new an(r).getReportDialogEndpoint(n)),
  ...
  function Xn(n, t, r) {
        ...
        throw (
          ...
          un(function (r) {
            r.addEventProcessor(function (n) {
              var r = e({}, n);
              return t.mechanism && _(r, void 0, void 0, t.mechanism), (r.extra = e({}, r.extra, { arguments: U(i, 3) })), r;
            }),
              captureException(n);
          }),
          n)
    ...
    (n.prototype = n.prototype || {}),
      ...
      Object.defineProperty(n, '__sentry_wrapped__', { enumerable: !1, value: sentryWrapped }),
      ...
      function (r) {
        if (((An = void 0), r && Un !== r)) {
          ...
          var e = function () {
            var t;
            try {
              t = r.target ? Kn(r.target) : Kn(r);
            } catch (n) {
              t = '<unknown>';
            }
            0 !== t.length && nn().addBreadcrumb({ category: 'ui.' + n, message: t }, { event: r, name: n });
          };
          zn && clearTimeout(zn), t ? (zn = setTimeout(e)) : e();
        }
      }
    );
  }
  ...
  function Kn(n) {
    for (
      var t, r = n, e = [], i = 0, o = 0, u = ' > '.length;
      r && i++ < 5 && !('html' === (t = Zn(r)) || (i > 1 && o + e.length * u + t.length >= 80));

    )
      e.push(t), (o += t.length), (r = r.parentNode);
  ...
  function Zn(n) {
    ...
    if ((u.push(n.tagName.toLowerCase()), n.id && u.push('#' + n.id), (t = n.className) && d(t)))
  ...
  var Qn = (function () {
      function t(n) {
        (this.name = t.id), (this.on = e({ onerror: !0, onunhandledrejection: !0 }, n));
      }
      return (
          ...
          (Error.stackTraceLimit = 50),
            On(function (n, r, e) {
              if (!(Jn > 0)) {
                ...
                i && nn().captureEvent(i.An(n, e), { data: { stack: n }, originalException: e });
              }
            }),
            this.on.onerror && (T.log('Global Handler attached: onerror'), kn()),
            this.on.onunhandledrejection && (T.log('Global Handler attached: onunhandledrejection'), Tn());
        }),
        (t.prototype.An = function (n, t) {
          if (!d(n.message) && 'onunhandledrejection' !== n.mechanism) {
            var r = n.message;
            n.message = r.error && d(r.error.message) ? r.error.message : 'No error message';
          }
          if ('onunhandledrejection' === n.mechanism && (n.incomplete || 'failed' === n.mode)) return this.Un(n, t);
          var e = Nn(n),
            i = { mode: n.mode };
          n.message && (i.message = n.message), n.name && (i.name = n.name);
          var o = nn().getClient(),
            u = (o && o.getOptions().maxValueLength) || 250;
          return (
            _(
              e,
              n.original ? F(JSON.stringify(U(n.original)), u) : '',
              'onunhandledrejection' === n.mechanism ? 'UnhandledRejection' : 'Error',
              { data: i, handled: !1, type: n.mechanism }
            ),
            e
          );
        }),
        (t.prototype.Un = function (t, r) {
          var i = { level: n.Severity.Error };
          return (
            p(r)
              ? (i.exception = { values: [{ type: 'UnhandledRejection', value: 'Non-Error promise rejection captured with value: ' + r }] })
              : ((i.exception = {
                  values: [
                    { type: 'UnhandledRejection', value: 'Non-Error promise rejection captured with keys: ' + $(Object.keys(r).sort()) },
                  ],
                }),
                (i.extra = { __serialized__: N(r) })),
            i.exception.values &&
              i.exception.values[0] &&
              (i.exception.values[0].mechanism = {
                data: e(
                  { mode: t.mode },
      ...
      return (
        (n.prototype.Mn = function (n) {
          return function () {
            ...
            var e = t[0];
            return (t[0] = Xn(e, { mechanism: { data: { function: nt(n) }, handled: !0, type: 'instrument' } })), n.apply(this, t);
          };
        }),
        (n.prototype.Fn = function (n) {
          return function (t) {
            return n(
              Xn(t, { mechanism: { data: { function: 'requestAnimationFrame', handler: nt(n) }, handled: !0, type: 'instrument' } })
            );
          };
        }),
        (n.prototype.Pn = function (n) {
          ...
          r &&
            ...
            (D(r, 'addEventListener', function (t) {
              return function (r, e, i) {
                try {
                  'function' == typeof e.handleEvent &&
                    (e.handleEvent = Xn(e.handleEvent.bind(e), {
                      mechanism: { data: { function: 'handleEvent', handler: nt(e), target: n }, handled: !0, type: 'instrument' },
                    }));
                } catch (n) {}
                return t.call(
                  this,
                  r,
                  Xn(e, {
                    mechanism: { data: { function: 'addEventListener', handler: nt(e), target: n }, handled: !0, type: 'instrument' },
                  }),
                  i
                );
              };
        ...
        (n.prototype.setupOnce = function () {
          this.Ln = this.Ln;
          var n = w();
          D(n, 'setTimeout', this.Mn.bind(this)),
            D(n, 'setInterval', this.Mn.bind(this)),
            D(n, 'requestAnimationFrame', this.Fn.bind(this)),
            [
              'EventTarget',
              'Window',
              'Node',
  ...
  var tt,
    ...
    et = (function () {
      function t(n) {
        (this.name = t.id), (this.on = e({ console: !0, dom: !0, fetch: !0, history: !0, sentry: !0, xhr: !0 }, n));
      }
      return (
        (t.prototype.$n = function () {
          'console' in rt &&
            ['debug', 'info', 'warn', 'error', 'log', 'assert'].forEach(function (r) {
              r in rt.console &&
                D(rt.console, r, function (e) {
                  return function () {
                    for (var i = [], o = 0; o < arguments.length; o++) i[o] = arguments[o];
                    var u = {
                      category: 'console',
                      data: { extra: { arguments: U(i, 3) }, logger: 'console' },
                      level: n.Severity.fromString(r),
                      message: P(i, ' '),
                    };
                    'assert' === r &&
                      !1 === i[0] &&
                      ((u.message = 'Assertion failed: ' + (P(i.slice(1), ' ') || 'console.assert')),
                      (u.data.extra.arguments = U(i.slice(1), 3))),
        ...
        (t.prototype.qn = function () {
          'document' in rt &&
            (rt.document.addEventListener('click', Gn('click'), !1),
            rt.document.addEventListener('keypress', Vn(), !1),
            ['EventTarget', 'Node'].forEach(function (n) {
              var t = rt[n] && rt[n].prototype;
              t &&
                t.hasOwnProperty &&
                t.hasOwnProperty('addEventListener') &&
                (D(t, 'addEventListener', function (n) {
                  return function (t, r, e) {
                    return (
                      r && r.handleEvent
                        ? ('click' === t &&
                            D(r, 'handleEvent', function (n) {
                              return function (t) {
                        ...
                        : ('click' === t && Gn('click', !0)(this), 'keypress' === t && Vn()(this)),
                      n.call(this, t, r, e)
                    );
                  };
                }),
        ...
        (t.prototype.Hn = function () {
          (function () {
            ...
            if (e) {
              ...
              i.hidden = !0;
              try {
                e.head.appendChild(i), i.contentWindow && i.contentWindow.fetch && (r = n(i.contentWindow.fetch)), e.head.removeChild(i);
              } catch (n) {
            ...
            D(rt, 'fetch', function (r) {
              return function () {
                ...
                'string' == typeof u
                  ? (o = u)
                  : 'Request' in rt && u instanceof Request
                ...
                var s = nn().getClient(),
                  a = s && s.getDsn();
                if (a) {
                  var f = new an(a).getStoreEndpoint();
                ...
                return r
                  ...
                  .then(function (n) {
                    return (
                      ...
                      t.addBreadcrumb({ category: 'fetch', data: h, type: 'http' }, { input: e, response: n }),
                      n
                    );
                  })
                  .catch(function (r) {
                    throw (
                      (t.addBreadcrumb({ category: 'fetch', data: h, level: n.Severity.Error, type: 'http' }, { error: r, input: e }), r)
                    );
                  });
              };
            });
        ...
        (t.prototype.Wn = function () {
          ...
          if (
            ...
            var r,
              ...
              o,
              u = function (n, r) {
                var e = E(rt.location.href),
                  i = E(r),
                  o = E(n);
                o.path || (o = e),
                  (tt = r),
                  e.protocol === i.protocol && e.host === i.host && (r = i.relative),
                  e.protocol === o.protocol && e.host === o.host && (n = o.relative),
                  t.addBreadcrumb({ category: 'navigation', data: { from: n, to: r } });
              },
              c = rt.onpopstate;
          ...
          if ('XMLHttpRequest' in rt) {
            ...
            D(n, 'open', function (n) {
              return function () {
                for (var t = [], r = 0; r < arguments.length; r++) t[r] = arguments[r];
                var e = t[1];
                this.__sentry_xhr__ = { method: d(t[0]) ? t[0].toUpperCase() : t[0], url: t[1] };
                var i = nn().getClient(),
                  o = i && i.getDsn();
                if (o) {
                  var u = new an(o).getStoreEndpoint();
                  d(e) && u && e.includes(u) && (this.__sentry_own_request__ = !0);
                }
              ...
              D(n, 'send', function (n) {
                return function () {
                  ...
                  return (
                    i.__sentry_own_request__ && it(r[0]),
                      ...
                      !(function (n, t) {
                        n in t &&
                          ...
                          D(t, n, function (t) {
                            return Xn(t, {
                              mechanism: {
                                data: { function: n, handler: (t && t.name) || '<anonymous>' },
                                handled: !0,
                                type: 'instrument',
                              },
                            });
                    ...
                    'onreadystatechange' in i && 'function' == typeof i.onreadystatechange
                      ? D(i, 'onreadystatechange', function (n) {
                          return Xn(
                            n,
                            {
                              mechanism: {
                                data: { function: 'onreadystatechange', handler: (n && n.name) || '<anonymous>' },
                                handled: !0,
                                type: 'instrument',
                              },
                            },
        ...
        (t.prototype.setupOnce = function () {
          this.on.console && this.$n(),
            this.on.dom && this.qn(),
            this.on.xhr && this.Bn(),
            this.on.fetch && this.Hn(),
            this.on.history && this.Wn();
        }),
        (t.id = 'Breadcrumbs'),
        t
      );
  ...
  function it(t) {
    try {
      var r = JSON.parse(t);
      et.addBreadcrumb(
        { category: 'sentry', event_id: r.event_id, level: r.level || n.Severity.fromString('error'), message: j(r) },
        { event: r }
      );
    } catch (n) {
  ...
  var ot = 'cause',
    ...
    ct = (function () {
      function n(t) {
        void 0 === t && (t = {}), (this.name = n.id), (this.Jn = t.key || ot), (this.s = t.limit || ut);
      }
      return (
        (n.prototype.setupOnce = function () {
          V(function (t, r) {
        ...
        (n.prototype.setupOnce = function () {
          V(function (t) {
            if (nn().getIntegration(n)) {
              ...
              var r = t.request || {};
              return (
                (r.url = r.url || st.location.href),
                (r.headers = r.headers || {}),
                (r.headers['User-Agent'] = st.navigator.userAgent),
                e({}, t, { request: r })
              );
            }
            return t;
    ...
    ft = Object.freeze({ GlobalHandlers: Qn, TryCatch: Yn, Breadcrumbs: et, LinkedErrors: ct, UserAgent: at }),
    ht = [new bn(), new mn(), new Yn(), new et(), new Qn(), new ct(), new at()];
  var lt = {},
    vt = w();
  vt.Sentry && vt.Sentry.Integrations && (lt = vt.Sentry.Integrations);
  var dt = e({}, lt, wn, ft);
  return (
    (n.BrowserClient = Wn),
    (n.Hub = Z),
    ...
    (n.captureMessage = function (n, t) {
      ...
      return on('captureMessage', n, t, { originalException: n, syntheticException: r });
    }),
    (n.close = function (n) {
      var t = nn().getClient();
    ...
    (n.getCurrentHub = nn),
    (n.getHubFromCarrier = rn),
    (n.init = function (n) {
      if ((void 0 === n && (n = {}), void 0 === n.defaultIntegrations && (n.defaultIntegrations = ht), void 0 === n.release)) {
        var t = w();
    ...
    (n.showReportDialog = function (n) {
      void 0 === n && (n = {}), n.eventId || (n.eventId = nn().lastEventId());
      var t = nn().getClient();
