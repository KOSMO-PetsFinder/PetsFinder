	...
	//드래그 앤 드롭
	 /*  $(".sortable").sortable();   */
	  ...
	  function delImg(_this){
	      $(_this).parents('li').find('.ui-state-default').remove();
	  }
	})
</script>
 ...
 <div class="container">
    <div class="input-form-backgroud row">
      <div class="input-form col-md-12 mx-auto">
        ...
        <form method="post" action="<c:url value='/modifypdt'/>" enctype="multipart/form-data">
        <input type="hidden" name="product_idx" id="product_idx" value="${pdtedit.product_idx }" />
          <div class="row">
            <div class="col-md-6 mb-3">
              <label for="name">상품명</label>
              <input type="text" class="form-control" name="product_name" value="${pdtedit.product_name }" required>
            </div>
          </div>
         ...
         <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <input type="text" class="form-control" name="product_price" value="${pdtedit.product_price }" required>
            </div>
            
          </div>
			 <div class="mb-3">
            <label for="address">수량</label>
            <input type="number" class="form-control" name="product_stock" required value="${pdtedit.product_stock }"
            style="width:70px;">
          </div>
          <div class="mb-3">
            <label for="address">카테고리</label>
            <select name="product_category" class="form-control"  style="width:100px;">
            	<option value="${pdtedit.product_category }">선택</option>
          ...
          <div class="mb-3">
            ...
            <textarea name="product_description" cols="72" rows="5">${pdtedit.product_description }</textarea>
