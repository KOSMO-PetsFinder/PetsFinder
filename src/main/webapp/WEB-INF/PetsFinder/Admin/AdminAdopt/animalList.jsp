               ...
               <tbody>
                  <c:forEach items="${animalList }" var="row">
                     <tr>
                        ...
                        <c:if test="${ not a_stt }">
                            <c:if test="${ row.abani_stat == 'prtct' }">
                            <input id="abani_stat_${row.abani_idx }" type="hidden" name="abani_stat" value="prtct">
                            </c:if>
                            <c:if test="${ row.abani_stat == 'adopt' }">
                            <input id="abani_stat_${row.abani_idx }" type="hidden" name="abani_stat" value="adopt">
                            </c:if>
