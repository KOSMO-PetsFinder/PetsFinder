...
<form action="./QNAaction" method="post" enctype="multipart/form-data" onsubmit="return checkForm(this);">
	<input type="hidden" name="qna_stt" value="Inc" />
	...
	<div id="Q&A" style="display: flex; justify-content: center;">
		<div style="margin-top: 200px; border-top: 1px solid #cccccc; width: 1024px;">
			<div style="display:flex; border-bottom: 1px solid #cccccc;">
				<input id="title" name="qna_title" type="text" placeholder="제목을 입력하세요." style="font-size: 1.2em; width: 1000px; height: 52px; border: 0; margin: 0px 12px; padding: 1px 2px; outline: none; font-family: 'BM JUA_TTF'; "/>
				<!-- <p style="width: 5%; margin-top: 15px;">비공개</p><input type="checkbox" id="input_check" name="qna_OPENSTATUS" value="pri" />
				<input type="hidden" name="qna_OPENSTATUS" value="pub" id="input_check_hidden" /> -->
				<div class="form-check form-switch">
				  <input class="form-check-input"  type="checkbox" id="input_check1" name="qna_OPENSTATUS" value="pri" >
				  <label class="form-check-label" for="input_check1" >비공개</label>
				</div>
			</div>
			<div style="border-bottom: 1px solid #cccccc; padding-bottom: 20px; background-color: #fcfcfc;">
				<textarea id="content" name="qna_content" placeholder="내용을 입력하세요." style="outline: none; margin-top: 20px; padding: 0 12px" onkeydown="resize(this)"></textarea>
