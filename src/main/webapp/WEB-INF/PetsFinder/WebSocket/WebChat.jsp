...
<div class="row clearfix">
    <div class="col-lg-12">
<!-- 
	룸아이디(방의 구분자) "room_관리자idx_회원idx"로 생성하기  
-->    
<c:choose>
...
<input type="hidden" id="member_idx" name="member_idx" value="100">
    		...
    		<h2 style="text-align: center">Pets Finder 채팅</h2>
    		<!-- 채팅창 크기 div -->
                ...
                <div class="input-group">
	                ...
	                <ul class="list-unstyled chat-list mt-2 mb-0" >
										...
										<c:forEach items="${roomName }" var="roomName">
											<a href="WebChat.do?room_id=${roomName.room_id }&chat_id=${roomName.sender_id}&member_id=${roomName.receiver_id}&member_idx=${param.member_idx }&sit_idx=${param.sit_idx }">
												<li class="clearfix">
