	...
	<div class="view" >
		<div class="scrollBlind">
			...
			<form action="<c:url value='/'/>sitterApl" name="sitterApplFrm" method="post">
								...
								<div
									...
									<input type="hidden" name="gender" value="${gender }" />
										...
										<div
											...
											<p style="font-size: 17px; color: #333333; line-height: 50px"></p>
											<input class="form-control" type="button" value="F" name="gender" readonly checked class="btn btn-default"  style=" font-size: 17px; color: #333333;  width: 190px;">
										</div>
										<div
											...
											<p style="font-size: 17px; color: #333333; line-height: 50px"></p>
											<input class="form-control" type="button" value="M" readonly name="gender" class="btn btn-default"  style=" font-size: 17px; color: #333333;  width: 190px;">
										</div>
										</c:if>	
										<c:if test="${not gen }">	
										<div
											...
											<p style="font-size: 17px; color: #333333; line-height: 50px"></p>
											<input type="button" value="F" name="gender" readonly  class="btn btn-default"  style=" font-size: 17px; color: #333333;  width: 190px;">
										</div>											
										<div
											style="display: flex; justify-content: center; align-items: center; border: 2px solid #75c9ba; border-radius: 5px; flex-grow: 1; flex-basis: 0; height: 50px">
											<p style="font-size: 17px; color: #333333; line-height: 50px"></p>
											<input type="button" value="M" readonly name="gender" checked class="btn btn-default"  style=" font-size: 17px; color: #333333;  width: 190px;">
										</div>
										</c:if>
									</div>
				...
				<section style=" padding-bottom: 208px">
					<div style="width: 1000px; margin: 0px auto; padding-top: 84px">
