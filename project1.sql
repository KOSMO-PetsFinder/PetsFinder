...
COMMENT ON COLUMN ADOPTION_APPLICATION.ADPAPL_smkStt IS '신청자 가족 흡연여부 (0,1)';
COMMENT ON COLUMN ADOPTION_APPLICATION.ADPAPL_havepet IS '신청자가 반려동물 키운 기간';
COMMENT ON COLUMN ADOPTION_APPLICATION.ADPAPL_job IS '신청자 직업';
COMMENT ON COLUMN ADOPTION_APPLICATION.ADPAPL_catblo IS '방묘창 여부';
